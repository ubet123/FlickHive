    ...
    <div className={`px-6 pt-8 pb-2 ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-blue-50 text-gray-800'} transition-colors duration-300`}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          >
            <span className="text-orange-500">Trending Movies</span>
            <IoMdArrowDropdown
              className={`text-orange-500 transition-transform duration-300 group-hover:text-orange-600 ${expand ? 'rotate-180' : 'rotate-0'}`}
            />
          </h1>
